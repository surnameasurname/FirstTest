...
//--根据TIM_TimeBaseInitStruct 中指定的参数初始化TIMx 的时间基数单位
...
//--根据 TIM_ICInitStruct 中指定的参数初始化外设 TIMx
