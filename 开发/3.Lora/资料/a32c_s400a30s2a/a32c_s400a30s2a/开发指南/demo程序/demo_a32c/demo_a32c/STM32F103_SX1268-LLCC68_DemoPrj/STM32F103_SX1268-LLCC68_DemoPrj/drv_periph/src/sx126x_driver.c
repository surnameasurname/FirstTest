...
//--BUSY    
    ...
    GPIO_InitStructure.GPIO_Pin = RADIO_BUSY_PIN;
...
//--NRST NSS TXEN RXEN
    ...
    GPIO_InitStructure.GPIO_Pin = RADIO_NSS_GPIO_PIN | RADIO_NRESET_PIN | RADIO_SWITCH_TX_PIN | RADIO_SWITCH_RX_PIN;
...
{
    while( GPIO_ReadInputDataBit(RADIO_BUSY_PORT,RADIO_BUSY_PIN ) != 0 );
}
