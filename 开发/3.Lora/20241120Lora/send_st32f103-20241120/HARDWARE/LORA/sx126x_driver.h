...
#define NRST	PBout(10) //PB10
#define BUSY	PBout(11) //PB11
#define TXEN	PBout(12) //PB12
#define RXEN	PBout(13) //PB13

//#define USE_DIO2

#define NSS		PAout(4) //PA4
//#define SCK		PAout(5) //PA5
...
#define RADIO_SWITCH_TX_PORT                    	GPIOB
#define RADIO_SWITCH_TX_PIN                     	GPIO_Pin_12

#define RADIO_SWITCH_RX_PORT                        GPIOB
#define RADIO_SWITCH_RX_PIN                         GPIO_Pin_13

#define radio_rx_on()                               PBout(13) = 1
#define radio_rx_off()                              PBout(13) = 0

#ifndef USE_DIO2
	#define radio_tx_on()                           PBout(12) = 1
	#define radio_tx_off()                          PBout(12) = 0
#else
	#define radio_tx_on()                           	
	#define radio_tx_off()                          	
#endif          
